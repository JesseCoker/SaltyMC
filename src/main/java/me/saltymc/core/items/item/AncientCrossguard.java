...
public class AncientCrossguard extends CustomItem
{
    public AncientCrossguard(Main plugin)
    {
        super(plugin);
    }
    ...
    {
        return Component.text("Ancient Crossguard").color(NamedTextColor.WHITE);
    }
