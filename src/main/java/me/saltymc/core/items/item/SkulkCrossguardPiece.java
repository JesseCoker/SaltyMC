...
public class SkulkCrossguardPiece extends CustomItem
{

    public SkulkCrossguardPiece(Main plugin)
    {
        super(plugin);
    }
    ...
    {
        return Component.text("Skulk Crossguard Piece").color(NamedTextColor.DARK_AQUA);
    }
