...
public class ReinforcedIronHelmet extends CustomItem
{
    public ReinforcedIronHelmet(Main plugin)
    {
        super(plugin);
    }
    ...
    {
        return Component.text("Reinforced Iron Helmet");
    }
    ...
    protected void modifyItem(ItemStack itemStack)
    {
        ...
        attributeHolder.addAttribute(new AttributeHolder.AttributeData(Attribute.GENERIC_ARMOR, 3.0, EquipmentSlot.HEAD));
        attributeHolder.addAttribute(new AttributeHolder.AttributeData(Attribute.GENERIC_ARMOR_TOUGHNESS, 3.0, EquipmentSlot.HEAD));
