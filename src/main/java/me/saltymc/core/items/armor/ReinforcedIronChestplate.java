...
public class ReinforcedIronChestplate extends CustomItem
{
    public ReinforcedIronChestplate(Main plugin)
    {
        super(plugin);
    }
    ...
    {
        return Component.text("Reinforced Iron Chestplate");
    }
    ...
    {
        return "REINFORCED_IRON_CHESTPLATE";
    }
    ...
    protected void modifyItem(ItemStack itemStack)
    {
        ...
        attributeHolder.addAttribute(new AttributeHolder.AttributeData(Attribute.GENERIC_ARMOR, 8.0, EquipmentSlot.CHEST));
        attributeHolder.addAttribute(new AttributeHolder.AttributeData(Attribute.GENERIC_ARMOR_TOUGHNESS, 3.0, EquipmentSlot.CHEST));
