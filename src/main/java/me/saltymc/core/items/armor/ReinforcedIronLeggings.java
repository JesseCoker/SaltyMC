...
public class ReinforcedIronLeggings extends CustomItem
{
    public ReinforcedIronLeggings(Main plugin)
    {
        super(plugin);
    }
    ...
    {
        return Component.text("Reinforced Iron Leggings");
    }
    ...
    {
        return "REINFORCED_IRON_LEGGINGS";
    }
    ...
    protected void modifyItem(ItemStack itemStack)
    {
        ...
        attributeHolder.addAttribute(new AttributeHolder.AttributeData(Attribute.GENERIC_ARMOR, 6.0, EquipmentSlot.LEGS));
        attributeHolder.addAttribute(new AttributeHolder.AttributeData(Attribute.GENERIC_ARMOR_TOUGHNESS, 3.0, EquipmentSlot.LEGS));
