...
public class HerobrineAxe extends CustomItem
{
    public HerobrineAxe(Main plugin)
    {
        super(plugin);
    }
    ...
    {
        return Component.text("Herobrine Axe").color(NamedTextColor.GOLD);
    }
